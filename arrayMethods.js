...
// CODE HERE
const totalPopulation = populations.reduce(function(a,c){return a+c},0)
console.log('total popu: ',totalPopulation)
...
const totalOrders = orders.map(function(elem){return elem['price']*(1+elem['tax'])})
...
// CODE HERE
const bobsTotal = purchases.filter((elem) => elem.owner === 'Bob').reduce((a, c) => a + c.price,0)
